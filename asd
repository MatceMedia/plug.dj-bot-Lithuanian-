{
    ...
    "langset": "\/me Dabar kalba nustatyta į: %%LANGUAGE%%",
    ...
    "online": "\/me %%BOTNAME%% v%%VERSION%% Prisijungęs!",
    "welcome": "\/me Sveiki %%NAME%%",
    "welcomeback": "\/me Sveiki sugrįžę, %%NAME%%",
    "songknown": "\/me @%%NAME%%, Ši daina DJ istorijoje.",
    "notavailable": "\/me @%%NAME%%, the song you played was not available.",
    "timelimit": "\/me @%%NAME%%, Jūsų daina per ilga, maksimalus ilgis: %%MAXLENGTH%% minutes. Jūs neturite privilegijų leisti ilgesnes dainas.",
    ...
    "usernotfound": "\/me Vartotojas nerastas.",
    ...
    "spam": "\/me @%%NAME%%, prašome ne'spam'inti!.",
    ...
    "blinfo": "[@%%NAME%%] Juodojo sąrašo Info - Autorius: %%AUTHOR%%, Pavadinimas: %%TITLE%%, Dainos ID: %%SONGID%%",
    ...
    "chatcleared": "\/me [@%%NAME%%] Išvalė pokalbio langą.",
    ...
    "emojilist": "\/me Emoji sąrašas: %%LINK%%",
    ...
    "eta": "\/me @%%NAME%%, Jūsų pozicija %%POSITION%% in the waitlist and will reach the booth in approximately %%TIME%%.",
    "facebook": "\/me Paspauskite Patinka ant mūsų Facebook puslapio: %%LINK%%",
    ...
    "mutednotime": "\/me [@%%NAME%%] Užtildytas @%%USERNAME%%.",
    "mutedmaxtime": "\/me [@%%NAME%%] You can only mute for maximum %%TIME%% minutes.",
    "mutedtime": "\/me [@%%NAME%%] Laikinai užtildytas @%%USERNAME%% [ %%TIME%% min ].",
    "unmuted": "\/me [@%%NAME%%] Atitildytas @%%USERNAME%%.",
    ...
    "roomrules": "\/me Kambario taisykles rasite čia: %%LINK%%",
    ...
    "website": "\/me Apsilankykite mūsų svetainėje: %%LINK%%",
    "youtube": "\/me [%%NAME%%] Prenumeruokite mūsų YouTube kanalą: %%LINK%%",
